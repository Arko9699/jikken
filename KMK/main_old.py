...
keyboard.keymap = [
    ...
    KC.CAPS,    KC.A,   KC.S,  KC.D,  KC.F,  KC.G,   KC.H,  KC.J,    KC.K,   KC.L,  KC.SCLN,  KC.QUOT,   KC.ENT,   _____, KC.PGDN,
    KC.LSFT,    KC.Z,   KC.X,  KC.C,  KC.V,  KC.B,   KC.N,  KC.M, KC.COMM, KC.DOT,  KC.SLSH,  KC.RSFT,    _____,   KC.UP, KC.HOME,
