...
keyboard.keymap = [[                                    #LAYER0
    ...
    KC.LSFT,    KC.Z,    KC.X,  KC.C,  KC.V,  KC.B,   KC.N,  KC.M, KC.COMM, KC.DOT,  KC.SLSH, KC.RSFT,   _____,   KC.UP,  KC.END,
    KC.LCLT, KC.LGUI, KC.LALT, _____, _____, _____, KC.SPC, _____,   _____,  _____, KC.MO(1),   _____, KC.LEFT, KC.DOWN, KC.RGHT,
    ],[                                                 #LAYER1
     KC.GRV,   KC.F1,   KC.F2, KC.F3, KC.F4, KC.F5,  KC.F6, KC.F7,   KC.F8,  KC.F9,   KC.F10,  KC.F11,  KC.F12,   xxxxx,  KC.INS, 
      ...
      xxxxx,    KC.Z,    KC.X,  KC.C,  KC.V,  KC.B,   KC.N,  KC.M,   xxxxx,  xxxxx,    xxxxx,   xxxxx,   _____,   xxxxx, KC.PGDN,
