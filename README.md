...
Get your MCU ready for KMK by following ![this](https://github.com/KMKfw/kmk_firmware/blob/master/docs/en/Getting_Started.md). Check compatible MCUs ![here](https://circuitpython.org/downloads)
